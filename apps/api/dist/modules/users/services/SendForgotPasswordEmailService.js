...
let SendForgotPasswordEmailSercice = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const forgotPasswordTempalte = _path.default.resolve(__dirname, '..', 'views', 'forgot_password.hbs');
    ...
    await this.mailProvider.sendMail({
      ...
      subject: '[Samurai] Recuperação de senha',
      templateData: {
...
var _default = SendForgotPasswordEmailSercice;
